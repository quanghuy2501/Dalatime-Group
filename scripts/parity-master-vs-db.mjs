...
for(const r of ranges){
 ...
 const dbAgg=q.rows[0]; for(const k of Object.keys(dbAgg)) dbAgg[k]=Number(dbAgg[k]); dbAgg.interactions=dbAgg.like+dbAgg.comment+dbAgg.save+dbAgg.share; dbAgg.er=dbAgg.view?dbAgg.interactions/dbAgg.view:0;
